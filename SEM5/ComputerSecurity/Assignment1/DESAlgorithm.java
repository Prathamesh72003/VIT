...
public class DESAlgorithm {
	...
	public static void main(String[] args) {
		...
		int[][] S0 = {{1,0,3,2},{3,2,1,0},{0,2,1,3},{3,1,3,2}},S1 = {{0,1,2,3},{2,0,1,3},{3,0,1,0},{2,1,0,3}};


		// KEY GENERATION K1 AND K2

		System.out.println("**********KEY GENERATION**********");

		System.out.println(Arrays.toString(PlainText) + " = Plain text");
		...
		System.out.println("\n"+Arrays.toString(K1) + " = Key1\n");

		LS1_5(p10);		LS1_5(p10);
		LS6_10(p10);	LS6_10(p10);
		System.out.println(Arrays.toString(p10) + " = P10");
		int[] K2 = convert(P8, p10);							
		System.out.println("\n"+Arrays.toString(K2) + " = Key2\n");
		...
		int[] ip = convert(IP,PlainText);
		System.out.println(Arrays.toString(ip) + " = IP");		
		
		int[] ep = convert(EP,Arrays.copyOfRange(ip, 4, 9));
		System.out.println(Arrays.toString(ep) + " = EP");		
		...
		System.out.println(Arrays.toString(ep) + " = NewEP");		
		...
		System.out.println(Arrays.toString(ip_dec) + " = IP");		
