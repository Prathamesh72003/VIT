...
public class SimplifiedAES{
	...
	public static void main(String args[]){
		...
		System.out.print("\nXORed plain text after substitue nibble: " + xorPTSubNib);
		...
		String sMatrix[][] = {{xorPTRotNib2_4.substring(0, 4), xorPTRotNib2_4.substring(8, 12)}, {xorPTRotNib2_4.substring(4, 8) , xorPTRotNib2_4.substring(12)}}; 
		...
		for(int i = 0; i < me.length; i++){
			for(int j = 0; j < sMatrix.length; j++)	{		
				for(int k = 0; k < me.length; k++){
					int prt1 = Integer.parseInt(me[i][k]) * Integer.parseInt(sMatrix[k][j]);
