...
#line 1159 "y.tab.c"
  ...
  case 4: /* re: '(' re ')'  */
#line 54 "genparsetree.y"
        { strcpy ( productions[count++] , "(re)" ); }
#line 1165 "y.tab.c"
    break;

  case 5: /* re: re '*'  */
#line 56 "genparsetree.y"
        { strcpy ( productions[count++] , "re*" ); }
#line 1171 "y.tab.c"
    break;

  case 6: /* re: re '+'  */
#line 58 "genparsetree.y"
        { strcpy ( productions[count++] , "re+" ); }
#line 1177 "y.tab.c"
    break;

  case 7: /* re: re '|' re  */
#line 60 "genparsetree.y"
       {strcpy ( productions[count++] , "re | re" );}
#line 1183 "y.tab.c"
    break;

  case 8: /* re: re '.' re  */
#line 62 "genparsetree.y"
       {strcpy ( productions[count++] , "re . re" );}
#line 1189 "y.tab.c"
    break;
